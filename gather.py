# USAGE
# python gather.py --input selected_images --output images --csv output.csv
...
ap.add_argument("-c", "--csv", required=True, help="path to CSV file for image counts")
...
for imagePath in glob2.iglob(args["input"] + "/*/*.jpg"):
    ...
    if random.randint(0, 1) == 0:
        ...
        for i in xrange(0, numTimes):
            ...
            image.save(args["output"] + "/" + adjFilename, "JPEG")
    else:
        output.write("%s,%d\n" % (filename, 1))
